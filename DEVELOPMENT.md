...
```bash
git remote add encore encore://final-year-project-web-app-r9pi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/final-year-project-web-app-r9pi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/final-year-project-web-app-r9pi/settings/integrations/github)
